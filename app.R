...
#setwd("/Users/filinanurcahya/Desktop/thingstogetdone/Homework : School/BCH339N #-Project/BCH339N-Project/")
...
server <- function(input, output) {
            ...
            sample[,1] <- choices_01
            #results <- c('Muscle Wasting', 'Patches In Throat','High Fever', 
